    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'gender', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_serious_1: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'age', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_serious_1: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'openness', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_serious_1: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_serious_1: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_serious_1: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_serious_1: got unexpected plan from when clause 6"
                                with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                                  (rule.pattern(6),)) \
                                  as gen_7:
                                  for x_7 in gen_7:
                                    assert x_7 is None, \
                                      "bc_rules.check_serious_1: got unexpected plan from when clause 7"
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_serious_2: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_serious_2: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_serious_2: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_serious_2: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_serious_2: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_serious_2: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') > 6.5:
                                  if context.lookup_data('avg_neuroticism') <= 2.5:
                                    if context.lookup_data('avg_conscientiousness') > 1.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_serious_3: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_serious_3: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_serious_3: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_serious_3: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_serious_3: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_serious_3: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') <= 6.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_serious_4: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_serious_4: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_serious_4: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_serious_4: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_serious_4: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_serious_4: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') <= 6.5:
                                  if context.lookup_data('avg_agreeableness') <= 5.5:
                                    if context.lookup_data('age') <= 18.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_serious_5: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_serious_5: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_serious_5: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_serious_5: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_serious_5: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_serious_5: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') > 6.5:
                                  if context.lookup_data('avg_neuroticism') > 2.5:
                                    if context.lookup_data('avg_conscientiousness') <= 1.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_responsible_1: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_responsible_1: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_responsible_1: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_responsible_1: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_responsible_1: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_responsible_1: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') > 6.5:
                                  if context.lookup_data('avg_neuroticism') <= 2.5:
                                    if context.lookup_data('avg_conscientiousness') <= 1.5:
                                      rule.rule_base.num_bc_rule_successes += 1
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_responsible_2: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_responsible_2: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_responsible_2: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_responsible_2: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_responsible_2: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_responsible_2: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') <= 6.5:
                                  if context.lookup_data('avg_agreeableness') > 5.5:
                                    if context.lookup_data('avg_conscientiousness') <= 3.5:
                                      if context.lookup_data('age') > 18.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_responsible_3: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_responsible_3: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_responsible_3: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_responsible_3: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_responsible_3: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_responsible_3: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') <= 5.5:
                                  if context.lookup_data('age') > 18.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_extraverted: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_extraverted: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_extraverted: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_extraverted: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_extraverted: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_extraverted: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') > 6.5:
                                  if context.lookup_data('avg_neuroticism') > 2.5:
                                    if context.lookup_data('avg_conscientiousness') > 1.5:
                                      if context.lookup_data('avg_neuroticism') >= 5.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_lively_1: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_lively_1: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_lively_1: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_lively_1: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_lively_1: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_lively_1: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') <= 5.5:
                                  if context.lookup_data('age') <= 18.5:
                                    if context.lookup_data('avg_openness') <= 3.5:
                                      rule.rule_base.num_bc_rule_successes += 1
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_lively_2: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_lively_2: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_lively_2: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_lively_2: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_lively_2: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_lively_2: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') <= 5.5:
                                  if context.lookup_data('age') > 18.5:
                                    if context.lookup_data('avg_extraversion') <= 2.5:
                                      rule.rule_base.num_bc_rule_successes += 1
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_lively_3: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_lively_3: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_lively_3: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_lively_3: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_lively_3: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_lively_3: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') > 6.5:
                                  if context.lookup_data('avg_neuroticism') <= 2.5:
                                    if context.lookup_data('avg_conscientiousness') > 1.5:
                                      if context.lookup_data('age') <= 18.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_dependable_1: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_dependable_1: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_dependable_1: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_dependable_1: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_dependable_1: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_dependable_1: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') <= 6.5:
                                  if context.lookup_data('avg_agreeableness') > 5.5:
                                    if context.lookup_data('avg_conscientiousness') <= 3.5:
                                      if context.lookup_data('age') <= 18.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_dependable_2: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_dependable_2: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_dependable_2: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_dependable_2: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_dependable_2: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_dependable_2: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') <= 6.5:
                                  if context.lookup_data('avg_agreeableness') > 5.5:
                                    if context.lookup_data('avg_conscientiousness') > 3.5:
                                      if context.lookup_data('avg_extraversion') > 3.5:
    ...
    try:
      if all(map(lambda pat, arg:
        ...
        with engine.prove(rule.rule_base.root_name, 'age', context,
          ...
          for x_1 in gen_1:
            assert x_1 is None, \
              "bc_rules.check_dependable_3: got unexpected plan from when clause 1"
            with engine.prove(rule.rule_base.root_name, 'openness', context,
                              (rule.pattern(1),)) \
              as gen_2:
              for x_2 in gen_2:
                assert x_2 is None, \
                  "bc_rules.check_dependable_3: got unexpected plan from when clause 2"
                with engine.prove(rule.rule_base.root_name, 'neuroticism', context,
                                  (rule.pattern(2),)) \
                  as gen_3:
                  for x_3 in gen_3:
                    assert x_3 is None, \
                      "bc_rules.check_dependable_3: got unexpected plan from when clause 3"
                    with engine.prove(rule.rule_base.root_name, 'conscientiousness', context,
                                      (rule.pattern(3),)) \
                      as gen_4:
                      for x_4 in gen_4:
                        assert x_4 is None, \
                          "bc_rules.check_dependable_3: got unexpected plan from when clause 4"
                        with engine.prove(rule.rule_base.root_name, 'agreeableness', context,
                                          (rule.pattern(4),)) \
                          as gen_5:
                          for x_5 in gen_5:
                            assert x_5 is None, \
                              "bc_rules.check_dependable_3: got unexpected plan from when clause 5"
                            with engine.prove(rule.rule_base.root_name, 'extraversion', context,
                                              (rule.pattern(5),)) \
                              as gen_6:
                              for x_6 in gen_6:
                                assert x_6 is None, \
                                  "bc_rules.check_dependable_3: got unexpected plan from when clause 6"
                                if context.lookup_data('avg_agreeableness') > 6.5:
                                  if context.lookup_data('avg_neuroticism') > 2.5:
                                    if context.lookup_data('avg_conscientiousness') <= 1.5:
                                      if context.lookup_data('avg_neuroticism') <= 6.5:
